                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item dropdown nav-item selected">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdown3">
                                <a class="dropdown-item active" href="DechargeServlet">DESCHARGE DE MATERIELS</a>
                                <div class="dropdown-divider"></div>
                ...
                <div class="container">
                    ...
                    <div class="clearfix">
                        <div class="float-xl-right float-md-right float-lg-right ">
                            <form class="form-inline my-2 my-lg-0" action="DechargeServlet">
                        ...
                        <div class="float-left">
                            ...
                            <form  class="form-inline my-2 my-lg-0" action="DechargeServlet" >
                                ...
                                <select class="custom-select form-control my-2 mr-sm-2 " name="materiel">
                                    <option selected>Choisir un Materiel</option> 
                                    <c:forEach var="m" items="${materiels}">
                                        <option value="${m.getId()}">${m.getDesignation()}</option>
                                    </c:forEach>   
                                </select>
                    ...
                    <div class="tab-body">
                        <tbody> 
                            <c:forEach var="temp" items="${DECHARGE_LIST}">
                                <c:url var="deleteLink" value="DechargeServlet">
                                ...
                                <tr>
                                    ...
                                    <td><a href="#"></a>
                                        <a class="del"  href="DechargeServlet?command=DELETE&membreid=${temp.idmembre}&materielid=${temp.idmateriel}"><i class="ion-android-delete"></i></a>
                                    </td>
                                </tr>
