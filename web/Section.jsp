...
<html>
                    ...
                    <ul class="navbar-nav mr-auto">
                        <li class="nav-item dropdown selected">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdown1">
                                ...
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item active" href="SectionServlet">SECTIONS</a>
                                <div class="dropdown-divider"></div>
	...
	<div class="container">
            <div class="float-xl-right ">
                        <form class="form-inline my-2 my-lg-0" action="SectionServlet" >
            ...
            <form  class="form-inline my-2 my-lg-0" action="SectionServlet" method="get">
                <%! String com;%>
                    <% com =request.getParameter("command");%>
                    <%if ( com !=null && com.equals("LOAD")){%>
                    
                    <input type="hidden" name="command" value="UPDATE" />
                    <input type="hidden" name="SectionId" value="${Section.getIdSection()}" />
                    <%}else {%> <input type="hidden" name="command" value="ADD" /><%}%>
                            <input class="form-control my-2 mr-sm-2" type="text" name="Numero" 
                                   <%if (com!=null && com.equals("LOAD")){%>value="${Section.getNumero()}" <%}else {%>
                                   placeholder="Numero" <%}%>>
                            <input class="form-control my-2 mr-sm-2" type="text" name="Designation" 
                                   <%if (com!=null && com.equals("LOAD")){%>value="${Section.getDesignation()}" <%}else {%>
        ...
        <section class="tab-section clearfix">
            <table id="myTable2" class="table table-sm table-responsive-md table-responsive-sm  table-striped table-bordered">
                ...
                <div class="tab-body">
                    ...
                    <tbody>	
				<c:forEach var="temp" items="${SectionList}">
					
					<c:url var="tempLink" value="SectionServlet">
						<c:param name="command" value="LOAD" />
						<c:param name="SectionId" value="${temp.getIdSection()}" />
					</c:url>
